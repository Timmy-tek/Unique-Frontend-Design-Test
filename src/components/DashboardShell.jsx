...
export const DashboardShell = ({ children }) => {
  return (
    <div className="w-full min-h-screen bg-[#F5F5F3] flex items-center justify-center p-0 font-sans selection:bg-[#E8EB2A] selection:text-black">
      ...
      <div className="relative w-full max-w-[1520px] min-h-screen sm:min-h-[92vh] bg-[#55534E] rounded-none sm:rounded-[36px] p-2.5 sm:p-3.5 shadow-2xl border-0 sm:border border-[#484642] overflow-hidden flex flex-col justify-between">
