...
import {
  ...
  MedicationCapsule,
} from "./components/TimelineControlsAndNodes";
import {
  BloodPressureCard,
  SymptomsCard,
  EcgCard,
} from "./components/MedicalCards";
  ...
  return (
    <DashboardShell>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col justify-between gap-4 pr-4 lg:flex-row lg:items-center">
          <HeaderContour />
          <TopNavigation />
        </div>

        {/* Main Inner White Surface Container */}
        <div className="bg-[#F7F5EF] p-4 sm:p-6 lg:p-7 flex flex-col justify-between gap-6">
          ...
          <div className="relative flex flex-col justify-center flex-1 my-2">
            <TimelineControlsAndNodes />
            ...
            <div className="relative w-full py-2 pr-14">
              ...
              <div className="relative z-10 grid grid-cols-1 gap-8 pl-2 md:grid-cols-2 md:pl-10">
                {/* August Section */}
                <div className="relative flex flex-col gap-4">
                  <div className="flex items-center gap-3 bg-[#F7F5EF] pr-3 w-max z-10">
                    <div className="w-[20px] h-[20px] rounded-full bg-[#E8EB2A] border-2 border-black flex items-center justify-center shadow-xs z-10 cursor-pointer hover:scale-110 transition-transform">
                      <FileText
                        size={10}
                        className="stroke-black stroke-[2.5]"
                      />
                    </div>
                  ...
                  <svg
                    className="absolute top-[18px] left-[10px] w-24 h-36 pointer-events-none z-0 overflow-visible"
                    viewBox="0 0 96 144"
                  >
                    <path
                  ...
                  <div className="flex flex-col gap-5 pt-4 pl-8">
